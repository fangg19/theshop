...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    dispatch({ type: actionType.PRODUCT_CREATE_SUCCESS, payload: data });
  } catch (error) {
    dispatch({
...
export const updateProduct = (product) => async (dispatch, getState) => {
  try {
    dispatch({ type: actionType.PRODUCT_UPDATE_REQUEST });
...
export const createProductReview = (productId, review) => async (
  ...
  try {
    dispatch({ type: actionType.PRODUCT_CREATE_REVIEW_REQUEST });
    ...
    dispatch({ type: actionType.PRODUCT_CREATE_REVIEW_SUCCESS });
  } catch (error) {
    dispatch({
